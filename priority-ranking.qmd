...
[$n = 3$ &emsp; $x = (3, 1, 0)$ &emsp; $y = (2, 0, 3)$]{style="font-size: 1.15em; color: #ccc; font-family: 'Source Code Pro', monospace;"}

[Prefix sums: &ensp; $S(x) = (3, 4, 4)$ &emsp; $S(y) = (2, 2, 5)$]{style="font-size: 0.95em; color: #888;"}
:::
...
[PMM: $x_1 = 3 > 2$ &rarr; $x$]{style="font-size: 0.95em; color: #ddd;"}

[PLS: first diff at 1 &rarr; $x$]{style="font-size: 0.95em; color: #ddd;"}

::: {style="height: 2.5em;"}
:::

[$x$ **wins** &mdash; top-tier strength]{style="font-size: 0.9em; color: #c490f0; font-weight: 500;"}
...
[TMM: $S_3 = 4 < 5$ &rarr; $y$]{style="font-size: 0.95em; color: #ddd;"}

[TLS: $k^* = 3$, same &rarr; $y$]{style="font-size: 0.95em; color: #ddd;"}

::: {style="height: 2.5em;"}
:::

[$y$ **wins** &mdash; higher total]{style="font-size: 0.9em; color: #70d0a0; font-weight: 500;"}
...
[P-PROT: $a^*\!=\!1$, $r^*\!=\!2 \in H_1(x)$]{style="font-size: 0.9em; color: #ddd;"}

[Q-PROT: $a^*\!=\!3$, $r^*\!=\!1 \in H_3(x)$]{style="font-size: 0.9em; color: #ddd;"}

[$x$ **wins** &mdash; coverage breadth / peak excellence]{style="font-size: 0.9em; color: #f0a050; font-weight: 500;"}
:::
:::
...
<!-- ::: {style="text-align: center; margin-top: 1.5em;"}
[The split is 4&ndash;2: a genuine tension between concentrating strength at the top vs. spreading it broadly.]{style="font-size: 0.9em; color: #888; font-style: italic;"}
::: -->
...
::: {style="text-align: center; margin-top: 1em;"}
[Each characterizing axiom is satisfied by **exactly** the rules it characterizes.]{style="font-size: 0.85em; color: #888;"}
:::
...
::: {style="text-align: center; margin-top: 1.5em;"}
[Totals tied at 6. &ensp; Prefix sums: $S(A) = (2, 5, 6)$ vs $S(B) = (1, 5, 6)$.]{style="font-size: 1em; color: #ddd;"}

[First difference at $S_1$: &ensp; $2 > 1$ &ensp; &rarr; **Country A wins**]{style="font-size: 1.1em; color: #70d0a0; font-weight: 500;"}
:::

::: {style="text-align: center; margin-top: 1.2em;"}
[Same medal count, but A has more golds.]{style="font-size: 0.9em; color: #888;"}

[TLS: total medals first; among equals, favor gold concentration.]{style="font-size: 0.9em; color: #888; font-style: italic;"}
:::
...
[P-PROT demands breadth: protect the most critical categories first.]{style="font-size: 0.9em; color: #888; font-style: italic;"}
:::
...
[In B&J's symmetric setting, Maximin and Leximin **sort** coordinates before comparing &mdash; implicitly treating values across dimensions as commensurable.]{style="font-size: 0.95em; color: #bbb;"}

[The Protective criterion uses **coverage sets** &mdash; never aggregating across dimensions.]{style="font-size: 0.95em; color: #bbb;"}

[Under symmetry, dimensions have no identity &mdash; so this difference **cannot be tested**.]{style="font-size: 0.95em; color: #999; font-style: italic;"}
:::
...
::: {style="text-align: center; margin-top: 5%;"}
[Formally verified]{style="font-size: 1.6em; color: #e8e8e8; font-weight: 400;"}
:::
...
[[github.com/eduardo-zambrano/priority-ranking-lean](https://github.com/eduardo-zambrano/priority-ranking-lean)]{style="font-size: 0.8em; color: #555;"}
