...
## {#applications background-color="#0a0a0a"}
...
::: {style="position: absolute; bottom: 1em; right: 1.5em;"}
[[all six applications →](#app-applications)]{style="font-size: 0.6em; color: #555;"}
:::
...
## {#app-applications background-color="#0a0a0a"}
...
::: {style="position: absolute; bottom: 1em; right: 1.5em;"}
[[← back](#applications)]{style="font-size: 0.6em; color: #555;"}
:::
